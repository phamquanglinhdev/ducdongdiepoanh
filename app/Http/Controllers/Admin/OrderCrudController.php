...
class OrderCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::column('address')->label("Địa chỉ giao hàng");
        CRUD::column('payment_method')->label("Phương thức thanh toán");
        CRUD::column('status')->label("Trạng thái")->type("select_from_array")->options(["Chưa hoàn thành","Hoàn thành"]);
    ...
    public function showOrder($id=1){
        $order = Order::find($id);
        $packs = Pack::where("order_id","=",$id)->get();
        return view("admin.order",["order"=>$order,"packs"=>$packs]);
    }
}
